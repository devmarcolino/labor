...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-500 min-h-screen">
  ...
  <header class="p-2 flex justify-between w-full">
    <x-btn-account/>
    <a href="{{ route('enterprises.account.info') }}" class="p-3 rounded-full text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 transition">
    ...
    <div class="flex flex-col self-center items-center w-full gap-5 text-center px-5 py-5 sm:py-9">
      ...
      <div class="bg-white dark:bg-gray-800 flex flex-col items-center justify-center text-center rounded-[40px] shadow-labor w-full max-w-2xl py-5 px-5 mt-[5rem]">
        ...
        <div class="my-2">
          ...
          <h3 class="font-bold  text-gray-900 dark:text-white">{{ Auth::user()->nome_empresa }}</h3>
        </div>
      ...
      <div class="bg-white dark:bg-gray-800 items-center justify-center text-center rounded-[40px] shadow-labor w-full max-w-2xl py-3 px-5">
        ...
        <x-btn-outline-account href="{{ route('enterprises.analytics') }}">
          <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d='m3 12.5 3.857-3.213c1.634-1.362 2.708-1.222 4.119.189l.006.006c1.538 1.538 2.64 1.474 4.172.133L21 4.5M10 21v-8m-5 8v-6m14 6V11m-4.5 10v-7'/></svg>

          Relatório de gastos
        </x-btn-outline-account>

        <x-btn-outline-account href="{{ route('enterprises.edit.address') }}">
        ...
        <x-btn-outline-account href="{{ route('enterprises.settings') }}">
          <svg class="text-gray-800 dark:text-gray-100" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
