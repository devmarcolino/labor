<div>
    <a href="{{ route('enterprises.chat.user', $user->id) }}" class="flex items-center bg-white shadow-md rounded-full px-4 py-3 gap-3 w-full max-w-2xl hover:bg-gray-100 transition">
