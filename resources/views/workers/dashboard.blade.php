...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors duration-500 h-screen flex flex-col">
    ...
    <header class="flex items-center justify-between py-3 px-5">
        ...
        <button class="icon-btn">
            <a href="{{ url('workers/chat') }}" class="shadow-labor ">
                <svg width="24" height="24" fill="none" stroke="#374151" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d='M11.953 2.25c-2.317 0-4.118 0-5.52.15-1.418.153-2.541.47-3.437 1.186-.92.736-1.35 1.693-1.553 2.9-.193 1.152-.193 2.618-.193 4.446v.183c0 1.782 0 3.015.2 3.934.108.495.278.925.545 1.323.264.392.6.722 1.001 1.042.631.505 1.375.81 2.254 1V21a.75.75 0 0 0 1.123.65c.586-.335 1.105-.7 1.58-1.044l.304-.221a22 22 0 0 1 1.036-.73c.844-.548 1.65-.905 2.707-.905h.047c2.317 0 4.118 0 5.52-.15 1.418-.153 2.541-.47 3.437-1.186.4-.32.737-.65 1-1.042.268-.398.438-.828.546-1.323.2-.919.2-2.152.2-3.934v-.183c0-1.828 0-3.294-.193-4.445-.203-1.208-.633-2.165-1.553-2.901-.896-.717-2.019-1.033-3.437-1.185-1.402-.151-3.203-.151-5.52-.151z'/></svg>
            </a>
        </button>

        <ul class="flex items-center py-1.5 px-2.5 bg-gray-100 rounded-full shadow-sm" id="icon-tabs" data-tabs-toggle="#icon-tabs-content" role="tablist">
            <li role="presentation">
                <a href="#" 
                class="group flex px-5 py-2 rounded-full text-gray-500 aria-selected:bg-white aria-selected:text-blue-600 aria-selected:shadow-sm transition-all ease-linear duration-200" 
            ...
            <li role="presentation">
                <a href="#" 
                class="group flex px-5 py-2 ease-linear duration-200 rounded-full text-gray-500 aria-selected:bg-white aria-selected:text-blue-600 aria-selected:shadow-sm" 
        ...
        <button class="icon-btn">
            <a href="{{ url('workers/account') }}" class="text-gray-600 hover:text-gray-900 shadow-labor">
                <img src="../img/test-avatar.svg" alt="">
            </a>
        </button>
    </header>

    <main id="icon-tabs-content" class="p-3 flex-1 h-full">

        <div class="h-full" id="flame" role="tabpanel" aria-labelledby="flame-tab">
            <div class="relative h-full w-full border-match overflow-hidden shadow-lg">
                    
                <img src="../img/match-example.png" alt="Garçom com taças de champanhe" class="absolute inset-0 w-full h-full object-cover">

                <div class="relative flex flex-col justify-end w-full h-full bg-gradient-to-t from-black/80 to-transparent p-6 text-white">
                        
                    <h2 class="text-3xl font-bold">Garçom</h2>
                    <p class="text-sm text-gray-300/85">Trabalhe como garçom em São Caetano do Sul...</p>

                    <div class="mt-4 flex items-center gap-2 w-full rounded-full bg-black/30 py-2 px-3 backdrop-blur-sm">
                        <div class="flex h-8 w-8 items-center justify-center rounded-full bg-gray-300 text-sm font-semibold text-black">
                                AD
                        </div>
                        <div>
                            <p class="text-sm font-semibold">Adventree Buffet e Eventos</p>
